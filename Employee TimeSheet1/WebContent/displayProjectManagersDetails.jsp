...
<title>working under Super Admin</title>
</head>
...
<body>
 <h2 align="center">PROJECT MANAGER DETAILS</h2>
   <div class="navigation"> <a id="navigator" href="adminHome.jsp">HOME</a> </div>                                                                   
 <ul style="list-style-type:square"><li><p>The below table describes you brief details of the Project Manager's in the company</p></li></ul>
<table id="employee">
