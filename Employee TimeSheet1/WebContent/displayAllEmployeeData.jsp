...
<body>
 ...
 <ul style="list-style-type:square"><li><p>The below table describes you brief details of the Employees including Project Manager in the company</p></li></ul>
<table id="employee">
<tr>
...
while(rs.next()){
    ...
    <td><a href="deleteEmployeeDetails.jsp?Employee_id=<%=rs.getInt(1)%>">Delete</a> &nbsp &nbsp <a href="viewEmployeeCompleteDetailsAdminPage.jsp?Employee_id=<%=rs.getInt(1)%>">View</a></td>
	</tr>
