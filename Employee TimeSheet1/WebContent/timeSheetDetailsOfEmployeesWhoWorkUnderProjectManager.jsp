...
<title>timeSheet Details of employees who work under Project manager</title>
</head>
...
<body>
 ...
 <ul style="list-style-type:square"><li><p>The below table describes you brief TimeSheet details of the employee who work under project manager in the company</p></li></ul>
<table id="employee">
...
while(rs.next()){
    ...
    <td><a href="deleteEmployeeTimeSheetDetails.jsp?t_id=<%=rs.getInt(1)%>">Delete</a>  &nbsp &nbsp <a href="viewEmployeesCompleteTimeSheetDetails.jsp?t_id=<%=rs.getInt(1)%>">View</a></td>
